...
import MediaPlayer from "integration-api/dist/lib/entities/media_player.js";
    ...
    switch (cmdId) {
        case LIGHT_COMMANDS.TOGGLE:
            if (entity.attributes.state === LIGHT_STATES.OFF) {
                uc.getConfiguredEntities().updateEntityAttributes(entity.id, new Map([
        ...
        case LIGHT_COMMANDS.ON:
            ...
            uc.getConfiguredEntities().updateEntityAttributes("test_mediaplayer", new Map([[MEDIAPLAYER_ATTRIBUTES.VOLUME, 24]]));
            break;
